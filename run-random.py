#!/usr/bin/env python3
"""
VASCO runner (reworked, arg fix) — two modes:
...
Fix in this version:
- argparse now defines BOTH --pixel-scale-arcsec and --pixel-scale, mapping to the
  same destination; code uses args.pixel_scale_arcsec consistently.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Accept both spellings; map to the same destination
