...
def make_unmatched_with_stilts(
    sex_csv: Path,
    other_csv: Path,
    out_csv: Path,
    ra1: str,
...
def make_unmatched_from_cdss(
    sex_csv: Path, cdss_xmatch_csv: Path, out_csv: Path, tol_arcsec: float = 0.05
):
    ra2, dec2 = detect_radec_columns(
        cdss_xmatch_csv,
        [
