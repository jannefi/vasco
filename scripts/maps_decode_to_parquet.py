...
- Each file: 156-byte records = 39 x 4-byte integers (int32) (big-endian). [1](https://insta-my.sharepoint.com/personal/janne_ahlberg_insta_fi1/Documents/Microsoft%20Copilot%20Chat%20Files/run_gaia_ps1_full.sh)
- First record: header (39 int32) with sentinel -1 in slots 34..38 to endian-check. [1](https://insta-my.sharepoint.com/personal/janne_ahlberg_insta_fi1/Documents/Microsoft%20Copilot%20Chat%20Files/run_gaia_ps1_full.sh)
- Then NOBJ object records, each 39 int32 with documented scaling. [1](https://insta-my.sharepoint.com/personal/janne_ahlberg_insta_fi1/Documents/Microsoft%20Copilot%20Chat%20Files/run_gaia_ps1_full.sh)
...
def parse_header_bytes(hdr_bytes: bytes) -> Tuple[str, np.ndarray]:
    ...
    matching sentinel: header[34..38] == -1. [1](https://insta-my.sharepoint.com/personal/janne_ahlberg_insta_fi1/Documents/Microsoft%20Copilot%20Chat%20Files/run_gaia_ps1_full.sh)
