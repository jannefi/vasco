...
# -*- coding: utf-8 -*-
"""
Backfill tiles_registry.csv from existing tiles under ./data/tiles and ./data/tiles_by_sky.
"""
...
def main():
    ...
    tiles = list(iter_tile_dirs_any(tiles_root))
    if not tiles:
