...
def main():
    ...
    ap.add_argument('--ra', required=True, help='RA (sexagesimal hh:mm:ss.s or decimal degrees)')
    ap.add_argument('--dec', required=True, help='Dec (sexagesimal ±dd:mm:ss.s or decimal degrees)')
    ...
    Path(args.out).write_text(Path(out_csv).read_text(encoding='utf-8'), encoding='utf-8')
