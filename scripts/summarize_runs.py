...
now layout-aware: supports ./data/tiles and ./data/tiles_by_sky.
"""
...
def summarize_ir_flags(flags_parquet: Path, radius_arcsec: float) -> Dict:
    out = {
        "ir_total_rows": 0, "ir_strict_matches": 0, "ir_strict_match_rate": 0.0,
        "ir_sep_arcsec_median": float("nan"), "ir_sep_arcsec_p95": float("nan"),
        "ir_w1_snr_ge5": 0, "ir_w2_snr_ge5": 0, "ir_any_snr_ge5": 0,
        "ir_rows_with_bins": 0, "ir_partitions_with_bins": 0,
    }
    ...
    w1 = safe_num(df, "w1snr"); w2 = safe_num(df, "w2snr")
